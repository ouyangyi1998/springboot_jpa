package com.jerry.springboot_jpa_test.controller;

import com.jerry.springboot_jpa_test.base.controller.BaseController;
...
public class UserController extends BaseController {
    ...
    public ModelMap delete(String id)
    {
        try{
            ...
            if(user==null)
            {
                return getModelMap(StateParameter.FAULT,user,"找不到用户");
            }
        ...
        {
            e.printStackTrace();
            return getModelMap(StateParameter.FAULT,null,"删除成功");
        }
    }
